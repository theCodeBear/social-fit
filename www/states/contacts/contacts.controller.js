...
angular.module('fitFriend').controller('ContactsCtrl', function ($scope, $ionicPlatform, $cordovaContacts, $state, _) {
  ...
  $ionicPlatform.ready(function () {
    if (window.cordova) {
      ...
      console.info('NOT ON A MOBILE DEVICE SO DID NOT GRAB CONTACTS');
    }
  });
